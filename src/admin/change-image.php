...
if($query)
{
$msg="Đã cập nhật hình ảnh của bài đăng ";
}
else{
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Hình ảnh bài đăng hiện tại</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Hình ảnh tính năng mới</b></h4>
