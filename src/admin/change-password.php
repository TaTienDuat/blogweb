                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Thay đổi password</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Thay đổi password </b></h4>
                                    <hr />
...
<label class="col-md-4 control-label">Password hiện tại</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="col-md-4 control-label">Password mới</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="col-md-4 control-label"> Tiếp Password</label>
<div class="col-md-8">
