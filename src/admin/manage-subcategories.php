...
if($_GET['action']=='perdel' && $_GET['scid'])
{
	...
	$delmsg="Thể loại bị xóa vĩnh viễn!";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý nguồn tin</h4>
...
<td colspan="7" align="center"><h3 style="color:red">Không tìm thấy</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Xóa nguồn tin</h4>
...
<td><?php echo htmlentities($row['subcatpostingdate']);?></td>
<td><?php echo htmlentities($row['subcatupdationdate']);?></td>
<td><a href="manage-subcategories.php?resid=<?php echo htmlentities($row['subcatid']);?>"><i class="ion-arrow-return-right" title="Khôi phục"></i></a>
