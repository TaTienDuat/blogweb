...
if($query)
{
$msg="Đã thêm bài đăng thành công ";
}
else{
                         ...
                         <div class="row">
                              <div class="col-xs-12">
                                   <div class="page-title-box">
                                        <h4 class="page-title">Thêm bài </h4>
                                             ...
                                             <form name="addpost" method="post" enctype="multipart/form-data">
                                                  <div class="form-group m-b-20">
                                                       ...
                                                       <input type="text" class="form-control" id="posttitle"
                                                            name="posttitle" placeholder="Nhập tiêu đề" required>
                                                  </div>
...
?>
                                                  ...
                                                  <div class="form-group m-b-20">
                                                       <label for="exampleInputEmail1">Nguồn tin</label>
                                                  ...
                                                  <div class="row">
                                                       <div class="col-sm-12">
                                                            <div class="card-box">
                                                                 <h4 class="m-b-30 m-t-0 header-title"><b>Chọn hình ảnh</b></h4>
                                                  ...
                                                  <button type="submit" name="submit"
                                                       class="btn btn-success waves-effect waves-light">Lưu và đăng
                                                  </button>
                                                  <button type="button"
                                                       class="btn btn-danger waves-effect waves-light">Xóa bỏ</button>
                                             </form>
                                        </div>
                                   </div> <!-- end p-20 -->
                              </div> <!-- end col -->
